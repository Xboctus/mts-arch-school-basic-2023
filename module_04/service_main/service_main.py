...
class Presentation_With_Author(object):
    ...
    last_name = str
    date = str
    def __init__(self, title, email, birth_date, last_name, date):
        self.title = title
        self.email = email
        self.birth_date = birth_date
        self.last_name = last_name
...
async def read_presentation(title: str):
    ...
    presentationWithAuthor = Presentation_With_Author(presentation.title, author.email, author.birth_date, author.last_name, presentation.date)
